  ...
  <Image>
    <template #image>
      <div ref="imgContainerRef" :class="['relative overflow-hidden', props.class]" :style="[{ width: props.width, height: props.height, aspectRatio: props.aspectRatio }, props.style]">
        ...
        <template v-else>
          <img :src="imgSrc" :sizes="props.sizes" :style="{ objectFit: props.objectFit, objectPosition: props.objectPosition, width: 'inherit', height: 'inherit', margin: 'auto' }" :alt="props.alt">
